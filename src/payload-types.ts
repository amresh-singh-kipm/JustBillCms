...
/**
 * Each category with published posts gets an archive at /blog/category/<slug>.
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface FAQBlock {
  /**
   * Rendered as an H2. Leave empty to hide.
   */
  heading?: string | null;
  items: {
    question: string;
...
export interface SiteSetting {
  ...
  /**
   * Meta description for the /blog index and its paginated pages.
   */
  ...
  /**
   * Without the @. Leave empty if there is no account.
   */
